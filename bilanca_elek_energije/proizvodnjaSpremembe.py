...
axes.plot(hidroEl2012[:,1],hidroEl2012[:,0],color="blue",label="Hidro El")
#axes[0].plot(fotoEl2012[:,1],fotoEl2012[:,0],color="teal",label="Foto El")
axes.plot(termoEl2012[:,1],termoEl2012[:,0],color="red",label="TermoEl")
axes.plot(nuklearEl2012[:,1],nuklearEl2012[:,0],color="green",label="Nuklear")
#axes[0].plot(proizNaDistOmrEl2012[:,1],proizNaDistOmrEl2012[:,0],color="pink",label="Proiz na dist.omr")
axes.plot(uvozPrenosnoEl2012[:,1],uvozPrenosnoEl2012[:,0],color="yellow",label="Uvoz na prenosnem omr")
#axes[0].plot(uvozDistribucijskoEl2012[:,1],uvozDistribucijskoEl2012[:,0],color="black",label="Uvoz distribucijski")
axes.set_xlabel("Leto 2012")
axes.set_ylabel("Proizvodnja v GWh")
axes.set_xticks(mesci)
axes.set_xticklabels(np.array(meseci,dtype="str"),rotation=90)
axes.legend(loc=9,mode="expand")
axes.set_ylim(0, 900)


#axes[1].plot(prevzemSkupaj2013[:,1],prevzemSkupaj2013[:,0],color="darkblue",label="Skupaj")
axes.plot(hidroEl2013[:,1],hidroEl2013[:,0],color="blue",label="Hidro El")
#axes[1].plot(fotoEl2013[:,1],fotoEl2013[:,0],color="teal",label="Foto El")
axes.plot(termoEl2013[:,1],termoEl2013[:,0],color="red",label="TermoEl")
axes.plot(nuklearEl2013[:,1],nuklearEl2013[:,0],color="green",label="Nuklear")
#axes[1].plot(proizNaDistOmrEl2013[:,1],proizNaDistOmrEl2013[:,0],color="pink",label="Proiz na dist.omr")
axes.plot(uvozPrenosnoEl2013[:,1],uvozPrenosnoEl2013[:,0],color="yellow",label="Uvoz na prenosnem omr")
#axes[1].plot(uvozDistribucijskoEl2013[:,1],uvozDistribucijskoEl2013[:,0],color="black",label="Uvoz distribucijski")
axes.set_xlabel("Leto 2013")
axes.set_ylabel("Proizvodnja v GWh")
axes.set_xticks(mesci)
axes.set_xticklabels(np.array(meseci,dtype="str"),rotation=90)
axes.legend(loc=9,mode="expand")
...
axes.plot(hidroEl2014[:,1],hidroEl2014[:,0],color="blue",label="Hidro El")
#axes[2].plot(fotoEl2014[:,1],fotoEl2014[:,0],color="teal",label="Foto El")
axes.plot(termoEl2014[:,1],termoEl2014[:,0],color="red",label="TermoEl")
axes.plot(nuklearEl2014[:,1],nuklearEl2014[:,0],color="green",label="Nuklear")
#axes[2].plot(proizNaDistOmrEl2014[:,1],proizNaDistOmrEl2014[:,0],color="pink",label="Proiz na dist.omr")
axes.plot(uvozPrenosnoEl2014[:,1],uvozPrenosnoEl2014[:,0],color="yellow",label="Uvoz na prenosnem omr")
#axes[2].plot(uvozDistribucijskoEl2014[:,1],uvozDistribucijskoEl2014[:,0],color="black",label="Uvoz distribucijski")
axes.set_xlabel("Leto 2014")
axes.set_ylabel("Proizvodnja v GWh")
axes.set_xticks(mesci)
axes.set_xticklabels(np.array(meseci,dtype="str"),rotation=90)
axes.legend(loc=9,mode="expand")
...
axes.plot(hidroEl2015[:,1],hidroEl2015[:,0],color="blue",label="Hidro El")
#axes[3].plot(fotoEl2015[:,1],fotoEl2015[:,0],color="teal",label="Foto El")
axes.plot(termoEl2015[:,1],termoEl2015[:,0],color="red",label="TermoEl")
axes.plot(nuklearEl2015[:,1],nuklearEl2015[:,0],color="green",label="Nuklear")
#axes[3].plot(proizNaDistOmrEl2015[:,1],proizNaDistOmrEl2015[:,0],color="pink",label="Proiz na dist.omr")
axes.plot(uvozPrenosnoEl2015[:,1],uvozPrenosnoEl2015[:,0],color="yellow",label="Uvoz na prenosnem omr")
#axes[3].plot(uvozDistribucijskoEl2015[:,1],uvozDistribucijskoEl2015[:,0],color="black",label="Uvoz distribucijski")
axes.set_xlabel("Leto 2015")
axes.set_ylabel("Proizvodnja v GWh")
axes.set_xticks(mesci)
axes.set_xticklabels(np.array(meseci,dtype="str"),rotation=90)
axes.legend(loc=9,mode="expand")
...
axes.plot(hidroEl2016[:,1],hidroEl2016[:,0],color="blue",label="Hidro El")
#axes[4].plot(fotoEl2016[:,1],fotoEl2016[:,0],color="teal",label="Foto El")
axes.plot(termoEl2016[:,1],termoEl2016[:,0],color="red",label="TermoEl")
axes.plot(nuklearEl2016[:,1],nuklearEl2016[:,0],color="green",label="Nuklear")
#axes[4].plot(proizNaDistOmrEl2016[:,1],proizNaDistOmrEl2016[:,0],color="pink",label="Proiz na dist.omr")
axes.plot(uvozPrenosnoEl2016[:,1],uvozPrenosnoEl2016[:,0],color="yellow",label="Uvoz na prenosnem omr")
#axes[4].plot(uvozDistribucijskoEl2016[:,1],uvozDistribucijskoEl2016[:,0],color="black",label="Uvoz distribucijski")
axes.set_xlabel("Leto 2016")
axes.set_ylabel("Proizvodnja v GWh")
axes.set_xticks(mesci)
axes.set_xticklabels(np.array(meseci,dtype="str"),rotation=90)
axes.legend(loc=9,mode="expand")
axes.set_xticks(meseci2016)
axes.set_xlim([0.5,9.5])
axes.set_xticklabels(np.array(mesci2016,dtype="str"),rotation=90)
axes.set_ylim(0, 900)
'''
'''
